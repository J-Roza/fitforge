...
// ─────────────────────────────────────────────────────────────────────────────
//  MuscleBodyDiagram — carte musculaire vectorielle « à plat » (style app).
//  Chaque groupe musculaire est une zone de couleur : rouge = muscle primaire,
//  orange = muscles secondaires, mauve doux = au repos.
//
//  Polygones anatomiques : react-body-highlighter (licence MIT,
//  giavinh79/react-body-highlighter & HichamELBSI).
//  viewBox « 0 0 200 202 »  |  avant : x 0-100  |  arrière : x 100-200
// ─────────────────────────────────────────────────────────────────────────────
...
class MuscleBodyDiagram extends StatelessWidget {
  ...
  // Mapping MuscleGroup → identifiants SVG (avant et/ou arrière).
  ...
  static const _inactive = '#6E6690';
  static const _primary = '#FF3B30';
  static const _secondary = '#FF9500';

  String _buildSvg() {
    var svg = _kBodySvg;

    void paint(MuscleGroup m, String color) {
      for (final id in _svgIds[m] ?? const <String>[]) {
        svg = svg.replaceAll(
    ...
    // Les secondaires d'abord, le primaire ensuite : ainsi un muscle à la fois
    // primaire et secondaire reste rouge.
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              const _Dot(color: Color(_primaryInt), label: 'Primaire'),
              const SizedBox(width: 20),
              if (secondaryMuscles.isNotEmpty)
                const _Dot(color: Color(_secondaryInt), label: 'Secondaire'),
            ],
          ),
        ),
      ],
...
// Versions int des couleurs de légende (const).
const int _primaryInt = 0xFFFF3B30;
const int _secondaryInt = 0xFFFF9500;
...
// ─────────────────────────────────────────────────────────────────────────────
//  SVG — polygones react-body-highlighter (MIT). Muscles au repos : #6E6690,
//  peau/zones non ciblées : #3E3A52. Le rouge/orange est injecté à l'exécution
//  par substitution de chaîne (voir _buildSvg).
// ─────────────────────────────────────────────────────────────────────────────
const _kBodySvg = '''
<svg viewBox="0 0 200 202" xmlns="http://www.w3.org/2000/svg">
  ...
  <g fill="#3E3A52" stroke="#2A2740" stroke-width="0.3">
    ...
    <polygon points="6.12 88.57 10.20 75.10 14.69 70.20 16.33 74.29 19.18 73.47 4.49 97.55 0 100"/>
    <polygon points="84.49 69.80 83.27 73.47 80 73.06 95.10 98.37 100 100.41 93.47 89.39 89.80 76.33"/>
    <polygon points="77.55 72.24 77.55 77.55 80.41 84.08 85.31 89.80 92.24 101.22 94.69 99.59"/>
    <polygon points="6.94 101.22 13.47 90.61 18.78 84.08 21.63 77.14 21.22 71.84 4.90 98.78"/>
    <polygon points="186.38 75.74 191.06 83.40 193.19 94.04 200 106.38 196.17 104.26 188.09 89.36 184.26 83.83"/>
    <polygon points="113.62 75.74 108.94 83.83 106.81 93.62 100 106.38 103.83 104.26 112.34 88.51 115.74 82.98"/>
    <polygon points="181.28 79.57 177.45 77.87 179.15 84.68 191.06 103.83 193.19 108.94 194.47 104.68"/>
    <polygon points="118.72 79.57 122.13 77.87 120.85 84.26 109.36 102.98 106.81 108.51 105.11 104.68"/>
    <polygon points="33.88 140 34.69 143.27 35.51 147.35 36.33 151.02 35.10 156.73 29.80 156.73 27.35 152.65 27.35 147.35 30.20 144.08"/>
    <polygon points="65.71 140 72.24 147.76 72.24 152.24 69.80 157.14 64.90 156.73 62.86 151.02"/>
    <polygon points="134.47 153.19 131.06 159.15 133.62 166.38 137.45 162.55"/>
    <polygon points="166.38 153.62 162.98 162.98 166.81 166.38 169.36 159.15"/>
  </g>

  <!-- AVANT -->
  <g id="chest-f" fill="#6E6690" stroke="#2A2740" stroke-width="0.3">
  ...
  <g id="core-f" fill="#6E6690" stroke="#2A2740" stroke-width="0.3">
  ...
  <g id="biceps-f" fill="#6E6690" stroke="#2A2740" stroke-width="0.3">
  ...
  <g id="triceps-f" fill="#6E6690" stroke="#2A2740" stroke-width="0.3">
  ...
  <g id="shoulders-f" fill="#6E6690" stroke="#2A2740" stroke-width="0.3">
  ...
  <g id="legs-f" fill="#6E6690" stroke="#2A2740" stroke-width="0.3">
  ...
  <!-- ARRIÈRE -->
  <g id="back-b" fill="#6E6690" stroke="#2A2740" stroke-width="0.3">
  ...
  <g id="shoulders-b" fill="#6E6690" stroke="#2A2740" stroke-width="0.3">
  ...
  <g id="triceps-b" fill="#6E6690" stroke="#2A2740" stroke-width="0.3">
  ...
  <g id="glutes-b" fill="#6E6690" stroke="#2A2740" stroke-width="0.3">
  ...
  <g id="legs-b" fill="#6E6690" stroke="#2A2740" stroke-width="0.3">
